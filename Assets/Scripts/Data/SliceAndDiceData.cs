...
public class Ability
{
    ...
    public Ability(string name, AbilityType type, string cost, string effect)
    {
        this.name = name;
        this.type = type;
        this.cost = cost;
...
public static class BaseAbilityDatabase
{
    ...
    {
        // === SPELLS ===
        new Ability("Burst", AbilityType.Spell, "2 mana", "2 damage or shield 2"),
        new Ability("Mend", AbilityType.Spell, "2 mana", "Set a hero to 5 hp"),
        new Ability("Hemlock", AbilityType.Spell, "2 mana", "1 damage\npoison singleCast"),
        new Ability("Restore", AbilityType.Spell, "2 mana", "Heal 1 to all allies"),
        new Ability("Gaze", AbilityType.Spell, "1 mana", "Gain 1 reroll\nfuture cooldown"),
        new Ability("Bandage", AbilityType.Spell, "2 mana", "Heal and shield 1\nsingleCast cleave"),
        new Ability("Poke", AbilityType.Spell, "1 mana", "1 damage\ncooldown"),
        new Ability("Scroch", AbilityType.Spell, "2 mana", "1 damage\ncleave singleCast"),
        new Ability("Slice", AbilityType.Spell, "3 mana", "1 damage to all enemies"),
        new Ability("Gather", AbilityType.Spell, "2 mana", "Replace blank sides with \"2 mana\" this turn"),
        new Ability("Cut", AbilityType.Spell, "1 mana", "3 damage to an ally, then 2 damage to the top-most enemy\ncooldown"),
        new Ability("Slay", AbilityType.Spell, "3 mana", "Kill an enemy with exactly 3 hp"),
        new Ability("Imbue", AbilityType.Spell, "2 mana", "+1 pip to target's damage sides this turn\nsingleCast"),
        new Ability("Light", AbilityType.Spell, "1 mana", "Shield 1\ncleanse cleave singleCast"),
        new Ability("Balance", AbilityType.Spell, "3 mana", "1 damage to all enemies, then heal 1 to all allies"),
        new Ability("Vine", AbilityType.Spell, "1 mana", "1 damage or heal 1"),
        new Ability("Circle", AbilityType.Spell, "2 mana", "Add selfheal to allied sides this turn\nsingleCast"),
        new Ability("Glow", AbilityType.Spell, "1 mana", "Replace blank sides with 'Heal and shield 2' this turn"),
        new Ability("Infuse", AbilityType.Spell, "2 mana", "Heal 1 to all allies\nterminal"),
        new Ability("Renew", AbilityType.Spell, "1 mana", "Set a hero to 4 hp"),
        new Ability("Pray", AbilityType.Spell, "1 mana", "Heal and shield 1 to all dying allies\ndeplete"),
        new Ability("Flip", AbilityType.Spell, "2 mana", "Flip each side with its opposite this turn"),
        new Ability("Scald", AbilityType.Spell, "3 mana", "2 damage to all damaged enemies"),
        new Ability("Burn", AbilityType.Spell, "1 mana", "1 damage to all heroes and monsters\ncooldown"),
        new Ability("Flick", AbilityType.Spell, "1 mana", "1 damage\nengage cooldown"),
        new Ability("Spore", AbilityType.Spell, "1 mana", "Add decay & +1 pip to target's sides this turn\ncooldown"),
        new Ability("Zap", AbilityType.Spell, "1 mana", "Kill an enemy with exactly 2 hp\ncooldown"),
        new Ability("Chill", AbilityType.Spell, "2 mana", "2 damage\nweaken singleCast"),
        new Ability("Foretell", AbilityType.Spell, "3 mana", "+4 mana\nfuture"),
        new Ability("Drop", AbilityType.Spell, "3 mana", "4 damage to the top-most enemy"),
        new Ability("Clink", AbilityType.Spell, "4 mana", "Shield 1 to all allies\nboost singleCast"),
        new Ability("Liquor", AbilityType.Spell, "3 mana", "Heal 10\ncleanse"),
        new Ability("Strand", AbilityType.Spell, "4 mana", "Heal 2\nspellRescue"),
        new Ability("Operate", AbilityType.Spell, "3 mana", "Revive the top-most defeated ally\ndeplete"),
        new Ability("Salve", AbilityType.Spell, "1 mana", "Heal 2"),
        new Ability("Soothe", AbilityType.Spell, "4 mana", "Heal 1 to all allies\nregen"),
        new Ability("Bind", AbilityType.Spell, "3 mana", "Target ally becomes immune to damage this turn\ndeplete"),
        new Ability("Leech", AbilityType.Spell, "1 mana", "Kill an ally, then heal 5 to all allies\ncooldown"),
        new Ability("Ritual", AbilityType.Spell, "3 mana", "Heal 2\ncleanse cleave"),
        new Ability("Blades", AbilityType.Spell, "4 mana", "2 damage to all enemies"),
        new Ability("Miasma", AbilityType.Spell, "3 mana", "1 damage\npoison cleave"),
        new Ability("Inspire", AbilityType.Spell, "4 mana", "Another hero can use their dice again\ncooldown"),
        new Ability("Blaze", AbilityType.Spell, "6 mana", "13 damage"),
        new Ability("Crush", AbilityType.Spell, "3 mana", "3 damage to the top and bottom enemies"),
        new Ability("Tick", AbilityType.Spell, "4 mana", "1 damage\nweaken cleave"),
        new Ability("Draw", AbilityType.Spell, "1 mana", "Target ally 1\nboost deplete"),
        new Ability("Harvest", AbilityType.Spell, "1 mana", "Kill an enemy with exactly 1 hp, then +3 mana\ncooldown"),
        new Ability("Aid", AbilityType.Spell, "1 mana", "Heal 2 to all enemies"),
        new Ability("Bank", AbilityType.Spell, "4 mana", "3 mana\nfuture singleCast"),
        new Ability("Betray", AbilityType.Spell, "2 mana", "Kill an ally"),
        new Ability("Hinder", AbilityType.Spell, "1 mana", "1 damage to an ally\nweaken"),
        new Ability("Invoke", AbilityType.Spell, "1 mana", "Summon a demon"),
        new Ability("Mana", AbilityType.Spell, "1 mana", "+1 mana\nsingleCast"),
        new Ability("Niche", AbilityType.Spell, "2 mana", "Kill an enemy with exactly 46 hp"),
        new Ability("Tsrub", AbilityType.Spell, "2 mana", "Shield 2 to an enemy or 2 damage to an ally"),
        new Ability("Waste", AbilityType.Spell, "1 mana", "Replace blank sides with '1 damage death' this turn"),
        new Ability("Poultice", AbilityType.Spell, "1 mana", "Heal 2\nsingleCast"),
        new Ability("Remedy", AbilityType.Spell, "1 mana", "Heal 1\ncleanse singleCast"),
        new Ability("Wings", AbilityType.Spell, "2 mana", "Heal 3 to the top and bottom allies"),
        new Ability("Flare", AbilityType.Spell, "4 mana", "5 damage"),
        new Ability("Heat", AbilityType.Spell, "3 mana", "Heal 3 to all allies with shields\ncleanse"),
        new Ability("Sprout", AbilityType.Spell, "3 mana", "Heal 3\nchannel"),
        new Ability("Beam", AbilityType.Spell, "5 mana", "7 damage\nsingleCast ranged"),
        new Ability("Hack", AbilityType.Spell, "2 mana", "Replace blank sides with '4 damage' this turn"),
        new Ability("Hex", AbilityType.Spell, "3 mana", "Kill an enemy with exactly 6 hp\nranged singleCast"),
        new Ability("Invest", AbilityType.Spell, "4 mana", "+6 mana\nfuture cooldown"),
        new Ability("Mark", AbilityType.Spell, "4 mana", "2 damage\nvulnerable"),
        new Ability("Luck", AbilityType.Spell, "3 mana", "Gain 8 rerolls\nfuture cooldown"),
        new Ability("Charge", AbilityType.Spell, "2 mana", "Shield 2\nboost singleCast"),
        new Ability("Spark", AbilityType.Spell, "4 mana", "Add manaGain to target's sides this turn"),
        new Ability("Abyss", AbilityType.Spell, "5 mana", "Kill an enemy with half or less hp"),
        new Ability("Infinity", AbilityType.Spell, "13 mana", "Kill an enemy"),
        new Ability("Save", AbilityType.Spell, "1 mana", "Heal and shield 5\ncleanse singleCast"),
        new Ability("Bolt", AbilityType.Spell, "3 mana", "5 damage"),
        
        // --- Unused Spells ---
        new Ability("DSLash", AbilityType.Spell, "4 mana", "2 damage cruel channel"),
        new Ability("DSSlammo", AbilityType.Spell, "3 mana", "4 damage cooldown"),
        new Ability("DSSpikes", AbilityType.Spell, "3 mana", "Shield 1 cleave repel"),
        new Ability("DSResolve", AbilityType.Spell, "2 mana", "Heal 10 singlecase"),
        new Ability("DSGristle", AbilityType.Spell, "2 mana", "Add cleave & death to target's sides this turn"),
        new Ability("DSEnd", AbilityType.Spell, "1 mana", "3 damage to all enemies, then kill all allies"),
        new Ability("DSGong", AbilityType.Spell, "4 mana", "2 shields to ALL boost"),
        new Ability("DSSting", AbilityType.Spell, "3 mana", "1 damage weaken poison"),
        new Ability("DSDispell", AbilityType.Spell, "3 mana", "1 damage dispel"),
        new Ability("DSIntervene", AbilityType.Spell, "3 mana", "Heal 1 to all dying allies cleanse"),
        new Ability("DSReplenish2", AbilityType.Spell, "3 mana", "Heal and Shield 3"),
        new Ability("DST3blue00", AbilityType.Spell, "1 mana", "Kill all enemies with exactly 3 hp"),
        new Ability("DS2dmgclv", AbilityType.Spell, "4 mana", "2 damage cleave"),
        new Ability("DSSpotless", AbilityType.Spell, "2 mana", "Shield 2 to all undamaged allies"),
        new Ability("DSDuo", AbilityType.Spell, "2 mana", "Add pair to target's sides this turn"),
        new Ability("DSSplorb", AbilityType.Spell, "4 mana", "Heal 2 cleanse regen boost"),
        new Ability("DSTouch", AbilityType.Spell, "2 mana", "Target ally: Cannot die this turn deplete"),
        new Ability("DSShards", AbilityType.Spell, "2 mana", "2 damage to all enemies hyperboned cooldown"),
        new Ability("DSSpeed", AbilityType.Spell, "3 mana", "Add cantrip to target's sides this fight"),
        new Ability("DSTire", AbilityType.Spell, "5 mana", "Add Exert to enemy sides this turn"),
        new Ability("DSVarhest", AbilityType.Spell, "1 mana", "Kill an enemy with exactly 1 hp cooldown threesy manaGain"),
        new Ability("DSParadox", AbilityType.Spell, "3 mana", "1 damage spellRescue"),
        new Ability("DSBeep", AbilityType.Spell, "3 mana", "(2 damage heavy), then (heal 1 to all allies boost)"),

        // === TACTICS ===
        new Ability("Thrike", AbilityType.Tactic, "1x 3-pip side", "3 damage"),
        new Ability("Leaf", AbilityType.Tactic, "1x 1-keyword side &\n1x blank side", "Target ally 1\nboost"),
        new Ability("Mulch", AbilityType.Tactic, "1x any pip", "Heal 2"),
        new Ability("Parry", AbilityType.Tactic, "2x damage pips", "Shield 3"),
        new Ability("Else", AbilityType.Tactic, "1x blank side", "Shield 1\ncleanse"),
        new Ability("Slam", AbilityType.Tactic, "2x 1-keyword sides", "4 damage\nheavy"),
        new Ability("Devoid", AbilityType.Tactic, "1x blank side &\n2x damage pips", "Kill all enemies with 2 or less hp"),
        new Ability("Formation", AbilityType.Tactic, "3x damage pips &\n3x shield pips", "2 damage to all enemies, then shield 2 to all allies"),
        new Ability("Unite", AbilityType.Tactic, "1x damage pip,\n1x shield pip,\n1x heal pip &\n1x blank side", "15 damage"),
        new Ability("Burstic", AbilityType.Tactic, "2x mana pips", "2 damage or shield 2"),
        new Ability("Oof", AbilityType.Tactic, "5x blank sides", "5 damage"),
        
        // --- Unused Tactics ---
        new Ability("DTzzz", AbilityType.Tactic, "4x damage pips", "6 damage"),
        new Ability("DTReshape", AbilityType.Tactic, "1x 4 pip side", "Shield 4 Cleave"),
        new Ability("DTDestroy", AbilityType.Tactic, "20x any pips", "20 damage"),
        new Ability("DTStar", AbilityType.Tactic, "3x blank sides", "5 damage"),
        new Ability("DTthrow", AbilityType.Tactic, "2x damage pips", "2 damage Ranged"),
        new Ability("DTRecycle", AbilityType.Tactic, "3x any pips", "1 damage"),
        new Ability("DTFeint", AbilityType.Tactic, "1x heal pip & 1x shield pip", "2 damage"),
        new Ability("DTcomb", AbilityType.Tactic, "1x heal pip & 1x shield pip", "Heal and shield 1 to all allies"),
        new Ability("DToiwennn", AbilityType.Tactic, "4x shield pips", "Target hero can use their dice again")
    };
}
